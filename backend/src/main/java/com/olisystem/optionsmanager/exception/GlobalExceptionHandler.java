...
import com.olisystem.optionsmanager.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleInvalidIdFormatException(InvalidIdFormatException ex, WebRequest request) {
